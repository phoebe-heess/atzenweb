...
function processFile(filePath) {
  ...
  content = content.replace(/bg-zinc-900\/10/g, 'bg-brand-light-300 border-2 border-brand-dark-900 shadow-[4px_4px_0px_var(--color-ink)]');
...
processFile('/Users/ciarannash/Downloads/Atzengold/atzengold-web-main/src/components/ThreeDMap.tsx');
processFile('/Users/ciarannash/Downloads/Atzengold/atzengold-web-main/src/components/BrandHub.tsx');
